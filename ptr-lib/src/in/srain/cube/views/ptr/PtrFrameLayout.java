...
public class PtrFrameLayout extends ViewGroup {
    ...
    protected void onFinishInflate() {
        ...
        // System.out.println("on finish inflate   childCount ---> "+childCount);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        System.out.println("headView measureHeight before -->" + mHeaderView.getMeasuredHeight());
        System.out.println("contentView measureHeight before -->" + mContent.getMeasuredHeight());
        if (mHeaderView != null) {
        ...
        System.out.println("headView measureHeight -->" + mHeaderView.getMeasuredHeight());
        System.out.println("contentView measureHeight -->" + mContent.getMeasuredHeight());
    }
